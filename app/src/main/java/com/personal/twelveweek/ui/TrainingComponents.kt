...
fun ResistanceBandMark(
    ...
    Canvas(modifier = modifier) {
        ...
        drawPath(top, BandBlue.copy(alpha = alpha), style = Stroke(14.dp.toPx(), cap = StrokeCap.Round))
        drawPath(middle, BandCoral.copy(alpha = alpha), style = Stroke(10.dp.toPx(), cap = StrokeCap.Round))
